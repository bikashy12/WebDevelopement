...
function Form() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post("http://3001/api/user/", formData, {
        headers: {
          "Content-Type": "application/json",
        },
      });
          ...
          <div className="result-box">
            ...
            <div className="disclaimer">
              ...
              <p>
                ...
                <br />
                It is important to note that the predictions are solely based on
                the symptoms provided and do not take into account individual
                medical history, patient-specific factors, or laboratory test
                results. The accuracy of the predictions may vary, and there is
                a possibility of false positives or false negatives.
                <br />
                <br />
                This system should not be considered as a substitute for
                consulting with qualified healthcare professionals or seeking
                medical attention. If you have any concerns about your health or
                specific symptoms, it is highly recommended to consult a
                licensed healthcare provider. The developers and providers of
                this system assume no responsibility or liability for any
                actions taken based on the predictions or information provided.
              </p>
            </div>
            <button
              type="submit"
