...
// setparams(datas);
// setcount(0);
// setpersona_status(null);
// setactive_lifestatus(null);
// setgenderVisibility(false);
// setwizardTypee(false);
// setSpecial(false);
return () => {
 setBtnLoading(false);
};
  ...
  PushNotification.configure({
    ...
    onNotification: function (notification) {
      ...
      // dispatch(chatActions.update_total_count(chatData.total_chat_count+1));
      dispatch(chatActions.getAllChats());
    ...
    <View
      ...
      {count == 0 && (
        <View
          ...
          />
          <View style={{width:windowWidth,flexDirection:'row',justifyContent:'center',alignItems:'center',paddingBottom:15}}>
          <Image
