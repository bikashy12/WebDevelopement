...
export default function PetWishlists(props) {
  ...
  const [del_product_id, setdel_product] = React.useState(null);
            ...
            <View style={styles.modalView}>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <TouchableOpacity
                  ...
                  {loading ? <ActivityIndicator size='small' color='white' /> : <Text style={styles.textStyle}>yes</Text>}
                </TouchableOpacity>
              </View>
            </View>
          </View>
