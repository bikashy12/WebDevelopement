...
// connecting to mongodb database with help of mongoose
...
// creating the shcema for the posts
const contentSchema = new mongoose.Schema({
  title:String,
  content:String
})

// creating the model which will incorporate contentSchema
...
app.get("/posts/:post", function(req,res){
  ...
  posts.forEach(function(postElement){
    let storedTitle = _.lowerCase(postElement.title);
    if(requestedTitle === storedTitle){
        res.render("post",{post : postElement});
    }
    else{
